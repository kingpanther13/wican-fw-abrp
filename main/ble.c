...
static const uint16_t GATTS_CHAR_UUID_TEST_A       = 0xfff1;
//static const uint16_t GATTS_CHAR_UUID_TEST_B       = 0xfff2;
static const uint16_t GATTS_CHAR_UUID_TEST_C       = 0xfff2;
